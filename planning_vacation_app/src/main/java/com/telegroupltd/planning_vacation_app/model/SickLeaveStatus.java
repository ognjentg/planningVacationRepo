...
@Entity
@Table(name = "sick_leave_status", schema = "planning_vacation_db", catalog = "")
public class SickLeaveStatus implements HasActive {
    private Integer id;
    private String key;
    private String name;
    private Byte active;
    ...
    public boolean equals(Object o) {
        ...
        SickLeaveStatus that = (SickLeaveStatus) o;
