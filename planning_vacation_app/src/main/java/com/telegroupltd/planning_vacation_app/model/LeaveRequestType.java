...
@Entity
@Table(name = "leave_request_type", schema = "planning_vacation_db", catalog = "")
public class LeaveRequestType implements HasActive {
    private Integer id;
    private String key;
    private String name;
    private Byte active;
    ...
    public boolean equals(Object o) {
        ...
        LeaveRequestType that = (LeaveRequestType) o;
