var scriptsToLoad = [
    ...
    },
    {
        "section": "views",
        "path": "js/views/",
        "files": ["template", "sector", "user", "usergroup", "company", "calendar", "sectorInfo", "admins","secretary_sick_request", "companyInfo", "leave_requests", "absence","company_statistic"] // ADD VIEWS HERE
    },
    {
        "section": "core",
        "path": "js/",
